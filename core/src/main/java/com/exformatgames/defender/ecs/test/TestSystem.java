...
public class TestSystem extends IteratingSystem {
    ...
    protected void processEntity(Entity entity, float deltaTime) {
        ...
        if (buttonJustPressedComponent.buttons.contains(Input.Buttons.LEFT, false)){
            ...
            dir.nor().rotateDeg(buttonJustPressedComponent.mousePosition.angleDeg(dir)).scl(100);
            ...
            EntityBuilder.createComponent(bulletEntity, DeleteEntityComponent.class).timer = 2;
