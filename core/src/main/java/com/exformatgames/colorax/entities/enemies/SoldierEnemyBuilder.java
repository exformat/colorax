...
import com.exformatgames.colorax.entities.weapons.StandardBulletBuilder;
...
public class SoldierEnemyBuilder extends EnemyEntityBuilder {
    ...
    public void create(float x, float y) {
        ...
        Animation<TextureAtlas.AtlasRegion> walkAnimation = createAnimation("enemy_1_walk", 1f / 8);
        Animation<TextureAtlas.AtlasRegion> idleAnimation = createAnimation("enemy_1_idle", 1f / 8);
        ...
        createComponent(en, EnemyComponent.class).init(0.2f, 0, -0.295f);
        createComponent(en, HealthComponent.class).health = 100;

        createComponent(en, WeaponComponent.class).init(2, 5, 1).bulletBuilder = new StandardBulletBuilder();
    }
}
