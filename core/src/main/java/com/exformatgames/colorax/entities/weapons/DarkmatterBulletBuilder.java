...
public class DarkmatterBulletBuilder extends BulletBuilder{
    ...
    public void create(Vector2 position, Vector2 direction) {
        ...
        createComponent(en, SpriteComponent.class).init(atlas.findRegion("bullet_darkmatter", 1), 0.001f)
                .setPosition(position.x, position.y)
                .offsetRotation = direction.angleDeg();
        createComponent(en, ZIndexComponent.class).zIndex = 2;
        createComponent(en, SizeComponent.class).init(0.26f, 0.16f);
