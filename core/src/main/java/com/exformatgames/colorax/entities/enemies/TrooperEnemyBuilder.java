...
public class TrooperEnemyBuilder extends EnemyEntityBuilder {
    ...
    public void create(float x, float y) {
        ...
        Animation<TextureAtlas.AtlasRegion> walkAnimation = createAnimation("enemy_2_walk", 1f / 8);
        Animation<TextureAtlas.AtlasRegion> idleAnimation = createAnimation("enemy_2_idle", 1f / 8);
        ...
        createComponent(en, EnemyComponent.class).init(0.5f, 0, -0.295f);
        createComponent(en, HealthComponent.class).health = 120;

        createComponent(en, WeaponComponent.class).init(2, 4, 1).bulletBuilder = new BlasterBulletBuilder();
    }
}
